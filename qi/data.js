var EPISODES = [
    ...
    "Dogs", 
    "Dictionaries", 
    "Death (Hallowe'enSpecial)", 
    "Drinks", 
    "Differences", 
    "Descendants (Children in NeedSpecial)", 
    "Doves", 
    "Divination[fn 4]", 
